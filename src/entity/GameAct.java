...
public class GameAct {
	 ...
	 * 星球的种类数
	 */
	public static final int MAX_TYPE = GameConfig.getSYSTEM_CONFIG().getNumOfStar();
	/**
	 * 星球图像大小
	 */
	...
	private static final int nearSide = GameConfig.getSYSTEM_CONFIG().getNearSide();
	...
	private boolean isNearBorder(int newX, int newY) {
		...
		return newX <= leftBorder || newX >= rightBorder || newY >= downBorder
				|| newY <= upBorder;
	}
